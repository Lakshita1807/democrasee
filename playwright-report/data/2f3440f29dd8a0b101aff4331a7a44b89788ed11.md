...
- Name: hardening.spec.js >> DemocraSee Hardening E2E >> should block bot submission via honeypot
- Location: tests\e2e\hardening.spec.js:33:5
...
Call log:
  - waiting for locator('#chat-input')
    - locator resolved to <input type="text" id="chat-input" maxlength="500" placeholder="Ask a question..." data-i18n-placeholder="askQuestion"/>
    - fill("Hello?")
...
- generic [ref=e1]:
  ...
  - dialog "Welcome to DemocraSee" [ref=e20]:
    ...
    - generic [ref=e26]:
      ...
      - button "Get Started" [active] [ref=e40] [cursor=pointer]: Get Started
```
